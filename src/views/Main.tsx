...
const Main = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
      ...
      <Header showAuthButtons={!currentUser} showDashboardButton={!!currentUser} />
          ...
          {userInfo ? (
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Continue managing your shared living space and connecting with your flatmates.
              </p>
              <button
                onClick={handleDashboardClick}
                className="px-8 py-3 bg-white text-purple-600 rounded-lg shadow-lg hover:bg-white/90 transition font-medium text-lg mb-12"
              >
                Go to Dashboard
              </button>
            </div>
